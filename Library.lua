...
local Utility = {}
local Objects = {}
function RBBattlesLib:DraggingEnabled(frame, parent)
...
local Name = "RBBattlesLibConfig.JSON"
...
function RBBattlesLib:ToggleUI()
...
function RBBattlesLib.CreateLib(kavName, themeList)
    ...
    table.insert(RBBattlesLib, kavName)
    ...
    RBBattlesLib:DraggingEnabled(MainHeader, Main)
    ...
    function RBBattlesLib:ChangeColor(prope,color)
...
return RBBattlesLiblocal RBBattlesLib = {}
